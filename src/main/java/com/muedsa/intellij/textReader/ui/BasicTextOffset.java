...
public class BasicTextOffset implements TextOffset {
    ...
    public BasicTextOffset(Rectangle visibleArea) {
        this();
        measure(visibleArea);
    }

    public BasicTextOffset() {
    ...
    public BasicTextOffset(EditorBackgroundOffsetType type, int offsetX, int offsetY) {
        this.type = type;
    ...
    public BasicTextOffset(EditorBackgroundOffsetType type, int offsetX, int offsetY, Rectangle visibleArea) {
        this(type, offsetX, offsetY);
        measure(visibleArea);
    }

    private void measure(Rectangle visibleArea) {
        if(!isMeasure()){
            switch (type){
                case LEFT_TOP:
